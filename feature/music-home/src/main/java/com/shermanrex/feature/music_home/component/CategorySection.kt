package com.shermanrex.feature.music_home.component
...
fun CategorySection(
    ...
    Row(
        ...
        TabBarModel.entries.forEachIndexed { index, item ->
            val isSelected = remember(currentTabState.id) {
                currentTabState.id == index
            }
            val animateFloat by animateFloatAsState(if (isSelected) 1f else 0.5f)
            Box(
